...
function foundationpress_scripts() {
    ...
    wp_enqueue_script( 'modernizr', get_stylesheet_directory_uri() . '/assets/javascript/vendor/modernizr.js', array(), '2.8.3', false );

    // Fastclick removes the 300ms delay on click events in mobile environments. Must be placed in header. (Not required).
    wp_enqueue_script( 'fastclick', get_stylesheet_directory_uri() . '/assets/javascript/vendor/fastclick.js', array(), '1.0.0', false );
    ...
    wp_enqueue_script( 'foundation', get_stylesheet_directory_uri() . '/assets/javascript/foundation.js', array('jquery'), '5.5.2', true );
