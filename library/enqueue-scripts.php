...
function foundationpress_scripts() {
    ...
    wp_register_script( 'modernizr', get_stylesheet_directory_uri() . '/js/vendor/modernizr.js', array(), '2.8.3', false );

    // Fastclick removes the 300ms delay on click events in mobile environments. Must be placed in header. (Not required)
    wp_register_script( 'fastclick', get_stylesheet_directory_uri() . '/js/vendor/fastclick.js', array(), '1.0.0', false );
    ...
    //wp_register_script( 'jquery', get_stylesheet_directory_uri() . '/js/vendor/jquery.js', array(), '2.1.3', true );
    ...
    wp_register_script( 'foundation', get_stylesheet_directory_uri() . '/js/foundation.js', array('jquery'), '5.5.1', true );
